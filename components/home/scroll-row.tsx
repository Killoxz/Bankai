...
export function ScrollRow({
  ...
  return (
    <div className="group/row relative">
      ...
      {canLeft && (
        <>
          <div className="pointer-events-none absolute inset-y-0 -left-1 z-[5] w-14 bg-gradient-to-r from-[hsl(var(--background))] to-transparent sm:w-20" />
      ...
      {canRight && (
        <>
          <div className="pointer-events-none absolute inset-y-0 -right-1 z-[5] w-14 bg-gradient-to-l from-[hsl(var(--background))] to-transparent sm:w-20" />
